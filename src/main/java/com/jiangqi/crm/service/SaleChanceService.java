...
import com.jiangqi.crm.query.SaleChanceQuery;
import com.jiangqi.crm.utils.AssertUtil;
import com.jiangqi.crm.utils.PhoneUtil;
import com.jiangqi.crm.vo.SaleChance;
import com.jiangqi.crm.dao.SaleChanceMapper;
import com.jiangqi.crm.enums.DevResult;
import com.jiangqi.crm.enums.StateStatus;
...
public class SaleChanceService extends BaseService<SaleChance, Integer> {
   ...
   /**
    * @Description:多条件分页查询营销机会 （返回的数据格式必须满足LayUi中数据表格要求的格式）
    * @Author: 江七
    * @Date: 2021/5/9 22:41
