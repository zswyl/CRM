package com.jiangqi.crm.aspect;

import com.jiangqi.crm.annoation.RequiredPermission;
import com.jiangqi.crm.exceptions.AuthException;
...
public class PermissionProxy {
    ...
    /**
     * 切面会拦截指定包下的指定注解
     *  拦截com.jiangqi.crm.annoation的RequiredPermission注解
     *
     *
     ...
     */
    @Around(value = "@annotation(com.jiangqi.crm.annoation.RequiredPermission)")
